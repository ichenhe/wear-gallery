...
dependencyResolutionManagement {
    versionCatalogs {
        ...
        create("androidx") {
            ...
            alias("constraintlayout").to("androidx.constraintlayout:constraintlayout:2.1.2")
            ...
            alias("fragment-ktx").to("androidx.fragment:fragment-ktx:1.4.0")
            bundle(
                "base",
                listOf(
                    "annotation",
            ...
            alias("exifinterface").to("androidx.exifinterface:exifinterface:1.3.3")
            alias("cardview").to("androidx.cardview:cardview:1.0.0")
            alias("work-runtime-ktx").to("androidx.work:work-runtime-ktx:2.7.1")
            ...
            alias("paging-runtime-ktx").to("androidx.paging:paging-runtime-ktx:3.1.0")
        ...
        create("lib") {
            ...
            alias("strikt-core").to("io.strikt:strikt-core:0.33.0")
